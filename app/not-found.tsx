  ...
  return (
    <main className="min-h-[80vh] flex flex-col justify-center px-6 pt-24">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-3 mt-10 font-satoshi text-lg text-forest hover:text-sage transition-colors duration-300 border-b border-transparent hover:border-sage pb-1"
        >
