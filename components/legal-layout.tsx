      ...
      <section className="min-h-[50vh] flex flex-col justify-end px-6 pt-24 pb-16">
        <div className="max-w-7xl mx-auto w-full">
          <ScrollReveal>
            ...
            <h1 className="font-outfit font-light text-4xl md:text-6xl text-off-white leading-[1.05] tracking-tight max-w-3xl">
              {title}
            </h1>
            <p className="mt-6 font-dm text-sm text-stone/60">
